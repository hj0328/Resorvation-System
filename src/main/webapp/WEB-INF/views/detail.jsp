...
<body>
		...
		<div class="ct main">
			<div>
				...
				<div class="section_store_details">
					...
					<div class="bk_more _open">
						<span class="bk_more_txt">펼쳐보기</span> <i class="fn fn-down2"></i>
					</div>
					<div class="bk_more _close" style="display: none;">
								...
								<ul class="detail_info_group">
									...
									<li class="detail_info_lst"><strong class="in_tit">[공지사항]</strong>
										<ul class="in_img_group">
											<li class="in_img_lst"><img alt="공지사항" class="img_thumb"
	...
	<script id="review-template" type="myTemplate">
        {{#each comments}}
        <li class="list_item">
            <div>
                ...
                <div class="info_area">
                    <div class="review_info">
                        ...
                        <span class="date">{{commentTime this}} 방문</span>
                    </div>
                </div>
            </div>
        </li>
