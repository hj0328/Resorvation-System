...
public class UserSql {
    ...
    public static final String SELECT_GRADE_BY_ID = "SELECT grade FROM user_info WHERE id= :userId";

    public static final String UPDATE_TYPE_AND_TOTAL_RESERVATION_COUNT_BY_ID = "UPDATE user_info SET total_reservation_count=:totalReservationCount, grade=:grade WHERE id= :userId";
}
